 ...
 *
 * Commandline:
 *    --api='gl:core=4.3' --extensions='GL_ARB_buffer_storage,GL_KHR_debug' c
 *
 * Online:
 *    http://glad.sh/#api=gl%3Acore%3D4.3&extensions=GL_ARB_buffer_storage%2CGL_KHR_debug&generator=c&options=
 *
 */
